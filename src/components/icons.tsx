  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9 9V4.5M9 9c0 1.5-1.5 3-3.75 3S1.5 10.5 1.5 9s1.5-3 3.75-3S9 7.5 9 9zm0 0V17.25M9 9l10.5-3v10.5m0 0c0 1.5-1.5 3-3.75 3s-3.75-1.5-3.75-3 1.5-3 3.75-3 3.75 1.5 3.75 3z"
      />
    </svg>
  );
}
...
export function StarOfDavidIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.2} className={className}>
      <path d="M12 2l8.66 15H3.34L12 2z" />
      <path d="M12 22L3.34 7h17.32L12 22z" />
    </svg>
  );
}
